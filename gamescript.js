...
// }
  ...
  shipAttack(enemy) {
      if (this.hitAccuracy()) {
          ...
          return `<br>${this.name} missed target!`;
      }
  }
}
...
const reset = () => {
  ...
  attackText.innerHTML = "<br> You are the captain of the USS Schwarzenegger, on a mission to destroy every last alien ship. Battle the aliens as you try to destroy them with your lasers.<br>";
